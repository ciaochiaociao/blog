...
#CLIENTS AND SESSIONS
	...
	suspend-client  # prefix C-z
	choose-client  # prefix D => detach the chosen client

	switch-client -p/-n  # prefix ( / prefix )
	...
	choose-tree  # prefix s  # Put a pane into tree mode, where a session, window or pane may be chosen interactively from a list. -s starts with sessions collapsed and -w with windows collapsed
